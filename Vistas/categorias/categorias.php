                    ...
                    <div class="card-body">
                        ...
                        <form id="categorias-form" >
                            ...
                            <div class="form-group">
                                <input type="text" name="id" id="id" placeholder="Codigo Categoria" maxlength="10" class="form-control" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="nombre" id="nombre" placeholder="Nombre del Categoria" maxlength="200" class="form-control" autocomplete="off" required>
                            </div> 
